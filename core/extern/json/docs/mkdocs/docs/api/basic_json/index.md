...
[`emplace_back`](emplace_back.md), [`insert`](insert.md), and [`operator[]`](operator[].md) for a non-existing
...
[`update`](update.md), and [`operator[]`](operator[].md) for a non-existing key) can yield a reallocation, in
